...
graph TB
    ...
    LOCO_ITEM --> LOCO_PROPS["<u>Обязательные поля:</u><br/><br/>• id: string<br/><br/>• series: string<br/><br/>• position: number"]

    %% Ветвь 3: Вагоны
    ROOT --> CARS["<b>cars[]</b> (массив)<br/>Вагоны в составе"]
    CARS --> CAR_ITEM["<b>Элемент массива</b> (объект)"]
    CAR_ITEM --> CAR_PROPS["<u>Обязательные поля:</u><br/><br/>• id: string<br/><br/>• series: string<br/><br/>• weight: number (тонны)"]
    ...
    ADJ_ITEM --> ADJ_PROPS["<u>Обязательные:</u><br/><br/>• kilometer: number<br/><br/>• actualLength: number (м)<br/><br/><u>Опциональные:</u><br/><br/>• reason: string"]
    ...
    PLAN_ITEM --> PLAN_PROPS["<u>Обязательные:</u><br/><br/>• start: number (м)<br/><br/>• end: number (м)<br/><br/>• type: 'straight' | 'circular' | 'transition'<br/><br/><u>Опциональные:</u><br/><br/>• radius: number (м)<br/><br/>• direction: 'left' | 'right'"]
    ...
    STAT_ITEM --> STAT_PROPS["<u>Обязательные:</u><br/><br/>• name: string<br/><br/>• coordinate: number (км)<br/><br/>• graphical: GraphicalProperties"]
    ...
    LIMIT_ITEM --> LIMIT_PROPS["<u>Обязательные:</u><br/><br/>• start: number (км)<br/><br/>• end: number (км)<br/><br/>• limit: number (км/ч)<br/><br/>• type: 'track_category' | 'custom' | 'temporary'"]
    ...
    OPT_ITEM --> OPT_PROPS["<u>Обязательные:</u><br/><br/>• distance: number (км)<br/><br/>• speed: number (км/ч)<br/><br/>• time: number (мин)"]
    ...
    SPEED_ITEM --> SPEED_PROPS["<u>Обязательные:</u><br/><br/>• distance: number (км)<br/><br/>• speed: number (км/ч)<br/><br/>• time: number (мин)"]
    ...
    OPT_REG_ITEM --> OPT_REG_PROPS["<u>Обязательные:</u><br/><br/>• start: number (км)<br/><br/>• end: number (км)<br/><br/>• mode: string"]
    ...
    LOCO_BAND_ITEM --> LOCO_BAND_PROPS["<u>Обязательные:</u><br/><br/>• start: number (км)<br/><br/>• end: number (км)<br/><br/>• mode: string"]
    ...
    STAT_GRAPH --> GRAPH_PROPS["<b>GraphicalProperties</b><br/><br/><u>Обязательные поля:</u><br/><br/>• layerPosition: number<br/><br/>• verticalPosition: number (px)<br/><br/>• horizontalPosition: number (px)<br/><br/>• fontSize: number (px)<br/><br/>• fontColor: string (hex)<br/><br/>• lineHeight: number (px)<br/><br/>• rotation: number (°)<br/><br/>• objectColor: string (hex)"]
