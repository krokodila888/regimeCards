...
import Stage2Locomotive from "./Stage2Locomotive";
...
export default function WorkspaceSidebar({
  ...
  useEffect(() => {
    ...
    // Когда track section выбран, добавляем stage2
    if (activeChart.workflow.trackSection) {
      newValue.push("stage2");
    }

    // Когда optimal curve рассчитан, добавляем stage3
    if (activeChart.workflow.optimalSpeedCurve) {
      newValue.push("stage3");
    }
            ...
            <>
              ...
              <TooltipProvider>
                ...
                >
                  ...
                  {/* STAGE 2: Locomotive & Train Composition */}
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <AccordionItem
                        value="stage2"
